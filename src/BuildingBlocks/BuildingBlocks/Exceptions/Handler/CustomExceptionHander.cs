...
{
    public class CustomExceptionHander(ILogger<CustomExceptionHander> logger) : IExceptionHandler
    {
        public async ValueTask<bool> TryHandleAsync(HttpContext context, Exception exception, CancellationToken cancellationToken)
        {
            ...
            await context.Response.WriteAsJsonAsync(problemDatails, cancellationToken: cancellationToken);
            return true;
        }
    }
}
